...
//    public static final Advancement.Builder ROOT = create("root", Key.ROOT, () -> Advancement.Builder.advancement()
...
//                    .build())
//            .addCriterion(MAIN_CRITERION, PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.location())));
...
//    public static <T extends Advancement.Builder> Advancement.Builder create(final String name, Key key, Supplier<T> sup) {
