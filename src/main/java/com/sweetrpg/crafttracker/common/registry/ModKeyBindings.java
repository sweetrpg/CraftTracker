...
public class ModKeyBindings {
    ...
    public static final KeyBinding TOGGLE_SHOPPING_LIST_MAPPING = new KeyBinding(Constants.TRANSLATION_KEY_BINDINGS_TOGGLE_SHOPPING_LIST_TITLE, KeyConflictContext.GUI, InputMappings.Type.KEYSYM, GLFW.GLFW_KEY_H, Constants.KEY_BINDINGS_CATEGORY_TITLE);
