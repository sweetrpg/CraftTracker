...
public class CTLangProvider extends LanguageProvider {
    ...
    private void processENUS() {
        ...
        add(Constants.TRANSLATION_KEY_GUI_CRAFT_QUEUE_SECTION_PRODUCTS, "Products");
        add(Constants.TRANSLATION_KEY_GUI_CRAFT_QUEUE_SECTION_INTERMEDIATES, "Intermediates");
        add(Constants.TRANSLATION_KEY_GUI_CRAFT_QUEUE_SECTION_MATERIALS, "Materials");
        add(Constants.TRANSLATION_KEY_GUI_CRAFT_QUEUE_SECTION_FUEL, "Fuel");
        ...
        add(Constants.TRANSLATION_KEY_BINDINGS_SHARE_SHOPPING_LIST_TITLE, "Share Shopping List");
    ...
    private void processDEDE() {
        ...
        add(Constants.TRANSLATION_KEY_GUI_CRAFT_QUEUE_SECTION_PRODUCTS, "Produkte");
        add(Constants.TRANSLATION_KEY_GUI_CRAFT_QUEUE_SECTION_INTERMEDIATES, "Zwischenprodukte");
        add(Constants.TRANSLATION_KEY_GUI_CRAFT_QUEUE_SECTION_MATERIALS, "Materialien");
        add(Constants.TRANSLATION_KEY_GUI_CRAFT_QUEUE_SECTION_FUEL, "Kraftstoff");
        ...
        add(Constants.TRANSLATION_KEY_BINDINGS_SHARE_SHOPPING_LIST_TITLE, "Einkaufsliste teilen");
